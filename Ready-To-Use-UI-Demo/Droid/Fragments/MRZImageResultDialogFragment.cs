...
{
    public class MRZImageResultDialogFragment : BaseDialogFragment
    {
        public const string NAME = "MRZImageResultDialogFragment";

        public static MRZImageResultDialogFragment CreateInstance(Workflow flow, List<WorkflowStepResult> results)
        {
            var f = new MRZImageResultDialogFragment();
