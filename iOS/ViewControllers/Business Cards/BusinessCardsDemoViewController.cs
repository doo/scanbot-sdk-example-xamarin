...
         private bool IsPanelOpened()
        ...
        public bool ShouldSelectItem(UICollectionView collectionView, NSIndexPath indexPath)         {             UIImage image = _storage.ImageAtIndex((nuint)indexPath.Row);             string text = _ocrResults[indexPath.Row].RecognizedText;             _selectedCard = new BusinessCard(image, text);             return true;         }          [Export("collectionView:didSelectItemAtIndexPath:")]         public void ItemSelected(UICollectionView collectionView, NSIndexPath indexPath)         {             collectionView.DeselectItem(indexPath, true);         }
